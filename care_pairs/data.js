export const PAIRS = [
  ...
  { id: 'move', label: 'Movimento e Caminhada', emoji: '🏃', benefit: 'Corpo Ativo e Disposição', benefitEmoji: '👟' },
...
export const DIFFICULTIES = {
  facil: { label: 'Fácil', pairs: 6, cols: 3, limit: 60 },
  medio: { label: 'Médio', pairs: 8, cols: 4, limit: 90 },
  dificil: { label: 'Difícil', pairs: 12, cols: 4, limit: 120 },
};
